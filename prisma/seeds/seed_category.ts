...
export async function seedCategories() {
  const categories = [
    ...
    { code: 302, level: 3, description: 'CHEQUES', parent_id: 3, type: null },
    {
      code: 3021,
      level: 4,
      description: 'CHEQUES',
    ...
    { code: 302125, level: 6, description: 'PIX', parent_id: 3021, type: null },
    {
      code: 302126,
      level: 6,
    ...
    { code: 302128, level: 6, description: 'TEF', parent_id: 3021, type: null },
    {
      code: 302129,
      level: 6,
